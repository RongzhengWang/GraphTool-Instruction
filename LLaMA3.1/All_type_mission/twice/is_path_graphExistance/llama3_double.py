...
# 检查并读取现有的 JSON 文件内容
final_answer_file_path = '/home/data2t2/wrz/Graph Tools/Graph_LLaMA_test/All_type_mission/twice/is_path_graphExistance/ans_5ques.json'
...
# 读取所有任务文件
with open('/home/data2t2/wrz/Graph Tools/Graph_LLaMA_test/All_type_mission/twice/is_path_graphExistance/is_path_graphExistance_undirected_random100_5ques.json', 'r', encoding='utf-8') as file:
