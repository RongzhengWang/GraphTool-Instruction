...
# 检查并读取现有的 JSON 文件内容
final_answer_file_path = '/home/data2t2/wrz/Graph Tools/1LLaMA3.1/All_type_mission_directed/once/number_of_edges_graphCount/ans_graph.json'
...
# 读取所有任务文件
with open('/home/data2t2/wrz/Graph Tools/1LLaMA3.1/All_type_mission_directed/once/number_of_edges_graphCount/number_of_edges_graphCount_directed_random100_5ques.json', 'r', encoding='utf-8') as file:
