...
final_answer_file_path = '/home/data2t2/wrz/Graph Tools/API_Call/NLgraph_GLM4.json'
...
with open('/home/data2t2/wrz/Graph Tools/API_Call/is_path_NLGraph.json', 'r', encoding='utf-8') as file:
