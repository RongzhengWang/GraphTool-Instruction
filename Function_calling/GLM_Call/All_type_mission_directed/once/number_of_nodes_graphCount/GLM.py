...
tools = [ 
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Given a graph G and a node, returns whether or not the specified node exists.",
            "parameters": {
                "type": "object",
                "properties": {
                    "G": {
                    ...
                    "node": {
                        "type": "integer", 
                        "description": "The node which need to be checked.",
                    },
                },
                "required": ["G","node"],
            },
...
final_answer_file_path = '/home/data2t2/wrz/Graph Tools/API_Call/GLM/All_type_mission_directed/once/number_of_nodes_graphCount/GLM4.json'
...
with open('/home/data2t2/wrz/Graph Tools/API_Call/GLM/All_type_mission_directed/once/number_of_nodes_graphCount/number_of_nodes_graphCount_directed_random100_5ques.json', 'r', encoding='utf-8') as file:
