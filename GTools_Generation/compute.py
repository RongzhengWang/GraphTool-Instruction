...
def extract_api_input(json_file_path):
    ...
    for obj in json_objects:
        ...
        firstanswer_content = obj.get('firstanswer', {}).get('content', 'No firstanswer content found')
        secondanswer_content = obj.get('secondanswer', {}).get('content', 'No secondanswer content found')
