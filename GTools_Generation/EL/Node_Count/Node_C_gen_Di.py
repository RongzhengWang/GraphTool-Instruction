...
def graph_gen(min_nodes, max_nodes): 
    ...
    while Flag:
        ...
        if num_nodes <= 30 and num_nodes >= 20:
            ...
            p = 0.8  # Higher probability of edge generation
        else:
        ...
        for node_i in range(num_nodes):
            for node_j in range(num_nodes):  # Consider all node pairs for directed graph
                if node_i != node_j:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate examples for counting the number of nodes in directed graphs.")
...
# python Node_C_gen_Di.py --output_path /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Node_Count/Di/node_c_Di.json --output_dir /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Node_Count/Di/data --num_examples 500