...
def graph_gen_sum(min_nodes, max_nodes):
    while True:
        ...
        if len(G.edges) <= 1000:  # Adjust the edge limit
            break
    return G

def maximum_triangle_sum_example_gen(num_samples, output_path, output_dir):
    all_graphs_data = []
...
if __name__ == "__main__":
    ...
    maximum_triangle_sum_example_gen(args.num_examples, args.output_path, args.output_dir)


# python Triangle_gen.py --output_path /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Triangle/triangle.json --output_dir /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Triangle/data --num_examples 500