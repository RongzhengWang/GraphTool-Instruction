...
def graph_gen_with_capacity(min_nodes, max_nodes): 
    while True:
        ...
        if num_nodes <= 30 and num_nodes >= 20:
            ...
            p = 0.5  # Lower the probability of edge generation
        else:
...
# python Flow_gen_Un.py --output_path /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Flow/Un/flow_Un.json --output_dir /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Flow/Un/data --num_examples 500
