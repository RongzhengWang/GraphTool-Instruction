...
def graph_gen(min_nodes, max_nodes): 
    ...
    while Flag:
        ...
        if num_nodes <= 30 and num_nodes >= 20:
            ...
            p = 0.7  # Decrease the probability of edge generation
        else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate degree examples for undirected graphs.")
...
# python Degree_gen_Un.py --output_path /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Degree_Count/Un/degree_Un.json --output_dir /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Degree_Count/Un/data --num_examples 500
