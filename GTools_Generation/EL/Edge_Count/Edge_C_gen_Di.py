...
def graph_gen(min_nodes, max_nodes): 
    ...
    while Flag:
        ...
        if num_nodes <= 30 and num_nodes >= 20:
            ...
            p = 0.85  # Higher probability for edge generation
        else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate edge count examples for directed graphs.")
...
# python Edge_C_gen_Di.py --output_path /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Edge_Count/Di/edge_c_Di.json --output_dir /home/data2t2/wrz/GraphTool-Instruction/GTools/Test/EL/Edge_Count/Di/data --num_examples 500