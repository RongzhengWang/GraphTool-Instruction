...
# 读取 prompt 模板
with open('/home/data2t2/wrz/Graph Tools/prompt_template/prompt3 woGI.txt', 'r', encoding='utf-8') as file:
    prompt = file.read()

# 检查并读取现有的 JSON 文件内容
final_answer_file_path = '/home/data2t2/wrz/Graph Tools/Graph_LLaMA_test/All_type_mission_directed/twice/is_path_graphExistance/ans_5ques_woGI.json'
...
# 读取所有任务文件
with open('/home/data2t2/wrz/Graph Tools/Graph_LLaMA_test/All_type_mission_directed/twice/is_path_graphExistance/is_path_graphExistance_directed_random100_5ques.json', 'r', encoding='utf-8') as file:
