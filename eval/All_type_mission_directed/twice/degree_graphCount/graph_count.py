...
# 调用函数并传入文件路径
file_path = "/home/data2t2/wrz/Graph Tools/Graph_LLaMA_test/All_type_mission_directed/twice/degree_graphCount/ans_graph_GLandEX.json"
...
for graph_data in graph_data_list:
    if are_lists_equal(graph_data['edges'], graph_data['prompt_list']):
        ...
        print(f'prompt_list: {graph_data['prompt_list']}')
        print('---------------------------------------')
