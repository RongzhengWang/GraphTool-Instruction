...
def main(graph_path, ans_path):
    ...
    for i in range(total_entries):
        ...
        if i < len(ans_5ques_data):
            ...
            if api_name == "is_path_graphExistance":
                try:
                    # Detect if there is an edge between path_source and path_target
                    is_edge = nx.has_path(graph, path_source, path_target)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Check the path existence in graphs from JSON files.")
...
# python Path_e_Di.py --graph_path /home/data2t2/wrz/GraphTool-Instruction/GraphForge_test_WL/Path_Existence/Di/ans_graph_Di.json --ans_path /home/data2t2/wrz/GraphTool-Instruction/GraphForge_test_WL/Path_Existence/Di/ans_Di.json